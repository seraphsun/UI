...
/**
 * This interface gives you chance to inject your own animation or do something when the {@link PagerBase} animation (PagerTransformer) starts or ends.
 *
 * There are two items you have to know. The first item is the slider you are dragging.
 * This item I call it Current Item. The second is the slider that gonna to show. I call that Next Item.
 *
 ...
 *
 * You can see a demo class {@link AnimDescription}, this class gives the description text an animation.
 */
