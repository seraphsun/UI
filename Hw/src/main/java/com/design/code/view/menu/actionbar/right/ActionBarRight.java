package com.design.code.view.menu.actionbar.right;
 ...
 */
public class ActionBarRight extends DialogFragment {

    public static final String TAG = ActionBarRight.class.getSimpleName();
    ...
    @Deprecated
    public static ActionBarRight newInstance(int actionBarSize, List<MenuObject> menuObjects) {
    ...
    @Deprecated
    public static ActionBarRight newInstance(int actionBarSize, List<MenuObject> menuObjects, int animationDelay) {
        MenuObject.MenuParams params = new MenuObject.MenuParams();
        params.setActionBarSize(actionBarSize);
        params.setMenuObjects(menuObjects);
    ...
    @Deprecated
    public static ActionBarRight newInstance(int actionBarSize, List<MenuObject> menuObjects, int animationDelay, int animationDuration) {
        MenuObject.MenuParams params = new MenuObject.MenuParams();
        params.setActionBarSize(actionBarSize);
        params.setMenuObjects(menuObjects);
        params.setAnimationDelay(animationDelay);
    ...
    public static ActionBarRight newInstance(int actionBarSize, List<MenuObject> menuObjects, int animationDelay, int animationDuration, boolean fitsSystemWindow, boolean clipToPadding) {
        MenuObject.MenuParams params = new MenuObject.MenuParams();
        params.setActionBarSize(actionBarSize);
        params.setMenuObjects(menuObjects);
        params.setAnimationDelay(animationDelay);
     ...
     * 构造器
     */
    public static ActionBarRight newInstance(MenuObject.MenuParams menuParams) {
        ActionBarRight fragment = new ActionBarRight();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setStyle(STYLE_NO_FRAME, R.style.ActionBarRight);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup view = (ViewGroup) inflater.inflate(R.layout.fragment_2_actionbar_menu, container, false);
    ...
    public class MyFragmentAdapter {
        ...
        private ActionBarRight.OnMenuItemClickListener mOnItemClickListener;
        private ActionBarRight.OnMenuItemLongClickListener mOnItemLongClickListener;
        ...
        public void setOnItemClickListener(ActionBarRight.OnMenuItemClickListener listener) {
            mOnItemClickListener = listener;
        }

        public void setOnItemLongClickListener(ActionBarRight.OnMenuItemLongClickListener listener) {
