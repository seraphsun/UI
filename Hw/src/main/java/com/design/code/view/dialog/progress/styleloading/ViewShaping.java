package com.design.code.view.dialog.progress.styleloading;
 ...
 */
public class ViewShaping extends FrameLayout {
    ...
    public ViewShaping(Context context) {
        super(context);
    }

    public ViewShaping(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
        init(context, attrs);
    }

    public ViewShaping(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ViewShaping(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init(context, attrs);
    }

    private void init(Context context, AttributeSet attrs) {
        TypedArray t = context.obtainStyledAttributes(attrs, R.styleable.ViewShaping);
        mLoadText = t.getString(R.styleable.ViewShaping_loadingText);
        mTextAppearance = t.getResourceId(R.styleable.ViewShaping_loadingTextAppearance, -1);
    ...
    protected void onFinishInflate() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.dialog_shape_layout, null);
        mDistance = UtilDensity.dp2px(getContext(), 54f);
        LayoutParams layoutParams = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        layoutParams.gravity = Gravity.CENTER;

        mViewLoading = (ViewLoading) view.findViewById(R.id.shapeLoadingView);
     ...
     */
    public void upThrow() {
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(mViewLoading, "translationY", mDistance, 0);
        ObjectAnimator scaleIndication = ObjectAnimator.ofFloat(mIndicationIm, "scaleX", 0.2f, 1);
        ObjectAnimator objectAnimator1 = null;

        switch (mViewLoading.getShape()) {
            case SHAPE_RECT:
                objectAnimator1 = ObjectAnimator.ofFloat(mViewLoading, "rotation", 0, -120);
                break;
            case SHAPE_CIRCLE:
                objectAnimator1 = ObjectAnimator.ofFloat(mViewLoading, "rotation", 0, 180);
                break;
            case SHAPE_TRIANGLE:
                objectAnimator1 = ObjectAnimator.ofFloat(mViewLoading, "rotation", 0, 180);
                break;
    ...
    public void freeFall() {
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(mViewLoading, "translationY", 0, mDistance);
