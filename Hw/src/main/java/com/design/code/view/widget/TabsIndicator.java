...
public class TabsIndicator extends LinearLayout implements View.OnClickListener, OnPageChangeListener {
    ...
    private void handlerAttrs(Context context, AttributeSet attrs) {
        ...
        mTabPaddingTop = ta.getDimensionPixelOffset(R.styleable.TabsIndicator_PaddingTop, 0);
        mTabPaddingBottom = ta.getDimensionPixelOffset(R.styleable.TabsIndicator_PaddingTop, 0);
