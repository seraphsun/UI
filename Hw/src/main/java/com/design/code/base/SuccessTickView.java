...
public class SuccessTickView extends View {
    ...
    private final float CONST_RADIUS = UtilDensity.dp2px(getContext(), 1.2f);
    private final float CONST_RECT_WEIGHT = UtilDensity.dp2px(getContext(), 3);
    private final float CONST_LEFT_RECT_W = UtilDensity.dp2px(getContext(), 15);
    private final float CONST_RIGHT_RECT_W = UtilDensity.dp2px(getContext(), 25);
    private final float MIN_LEFT_RECT_W = UtilDensity.dp2px(getContext(), 3.3f);
    private final float MAX_RIGHT_RECT_W = CONST_RIGHT_RECT_W + UtilDensity.dp2px(getContext(), 6.7f);

    private float mMaxLeftRectWidth, mLeftRectWidth, mRightRectWidth;
    ...
    private void init() {
        mPaint = new Paint();
        mPaint.setColor(getResources().getColor(R.color.color_a5dc86));
